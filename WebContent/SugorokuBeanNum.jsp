...
<!-- header -->
 ...
 <div class="container">
  ...
  <div class="card text-white bg-dark mb-3" style="width: 70rem; margin: 0 auto;">
    <div class="row no-gutters">
        ...
        <div class="col-md-8"><br>
            <div class="card-body">
                <h3 class="card-title"><%=sugorokubean.rollDice() %>がでました。</h3><br><br>
                <div class="card-text"><p style="font-size: 30px;">
                「<%=sugorokubean.getDrinkText() %>」<br>
			    <%=sugorokubean.getAlcoholLvText() %></p><br>
			    現在の血中アルコール濃度は<%= sugorokubean.alcIntake() %>です。<br><br><br></div>
			    <div class="mxauto">
			   	<%
